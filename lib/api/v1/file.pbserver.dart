...
abstract class FileServiceBase extends $pb.GeneratedService {
  $async.Future<$0.Response> upload($pb.ServerContext ctx, $0.UploadRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'Upload': return $0.UploadRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      case 'Upload': return this.upload(ctx, request as $0.UploadRequest);
      default: throw $core.ArgumentError('Unknown method: $method');
    }
  }
